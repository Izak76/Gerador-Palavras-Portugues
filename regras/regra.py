...
class Regra(abc.ABC):
    ...
    def adicionar_regra(self, remover: str, adicionar: str, ocorrencia: str) -> None:
        self._sub_regras.append((remover, adicionar.split(
            "/")[0], self._criar_padrao_regex(ocorrencia)))

    def obter_sub_regras_registradas(self) -> list[tuple[str, str, re.Pattern]]:
        return self._sub_regras
